...
gnuplot << EOF
  ...
  plot '${f}' u 1:2 w l lw 2 lc rgb '#FF0000' t 'A-A-A angle', \
       '${f}' u 1:3 w l lw 2 lc rgb '#0000FF' t 'A-A-B angle', \
       '${f}' u 1:4 w l lw 2 lc rgb '#00AA00' t 'A-B-A angle'
  set key at graph x+mx,y
  plot '${f}' u 1:5 w l lw 2 dt (3,5) lc rgb '#00CCFF' t '1-2-3 angle', \
       '${f}' u 1:6 w l lw 2 dt (3,5) lc rgb '#AAAA00' t '2-3-4 angle', \
       '${f}' u 1:7 w l lw 2 dt (3,5) lc rgb '#000000' t '3-4-5 angle', \
       '${f}' u 1:8 w l lw 2 dt (3,5) lc rgb '#CC00CC' t '4-5-6 angle'
  unset multiplot
  unset output
EOF
